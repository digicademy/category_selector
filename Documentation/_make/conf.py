# -*- coding: utf-8 -*-
#
# Category Selector documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 02 Aug 2014 06:25:48 +0200.
#
...
htmlhelp_basename = 'category_selectordoc'
...
latex_documents = [
    ('Index', 'category_selector.tex', u'Category Selector',
...
pdf_documents = [
    ('Index', 'category_selector', u'Category Selector',
     u'Torsten Schrade'),
]
...
texinfo_documents = [
    ('Index', 'category_selector', u'Category Selector',
     u'Torsten Schrade', 'Category Selector', 'One line description of project.',
     'Miscellaneous'),
]
